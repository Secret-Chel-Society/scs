        ...
        <div className="flex flex-col h-full relative">
          ...
          <div className="relative z-10 flex items-center justify-between p-6 border-b-2 border-ice-blue-200/50 dark:border-rink-blue-700/50 bg-gradient-to-r from-ice-blue-100/50 to-rink-blue-100/50 dark:from-ice-blue-900/30 dark:to-rink-blue-900/30">
            ...
            <Button 
              ...
              size="icon" 
              onClick={onToggle} 
              className="lg:hidden hockey-button bg-gradient-to-r from-hockey-silver-500 to-hockey-silver-600 hover:from-hockey-silver-600 hover:to-hockey-silver-700 text-white shadow-lg hover:shadow-xl transition-all duration-300"
            >
              <X className="h-5 w-5" />
            </Button>
          </div>
