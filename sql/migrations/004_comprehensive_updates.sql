-- =====================================================
-- COMPREHENSIVE DATABASE MIGRATION - Version 2.0 Updates
-- =====================================================
-- This migration includes all necessary updates for the hockey league application
-- All changes are safe and will not delete existing data
-- =====================================================
...
COMMENT ON COLUMN matches.period_scores IS 'JSON object containing scores for each period';
