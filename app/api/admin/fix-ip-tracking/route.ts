...
export async function POST() {
  try {
    console.log("Setting up IP tracking...")
    ...
    const sql = `
      ...
      -- Note: No sequence permissions needed for UUID primary keys
    ...
    console.log("✅ IP tracking setup completed successfully")

    return NextResponse.json({
      success: true,
      message: "IP tracking setup completed successfully",
    })
  } catch (error: any) {
