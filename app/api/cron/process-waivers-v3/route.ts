...
export async function GET(request: NextRequest) {
  try {
    ...
    if (expiredError) {
      console.error('❌ Failed to fetch expired waivers:', expiredError)
    ...
    console.log(`✅ Processed ${processedWaivers.length} expired waivers`)
    ...
    console.error('❌ Process waivers cron error:', error)
    return NextResponse.json({
