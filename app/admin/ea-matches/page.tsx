        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center">
              ...
              <p className="text-white/70">Loading EA Matches management...</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="relative container mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-white/70 mt-1">Manage and view EA Sports NHL match data</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <Card className="bg-gradient-to-br from-slate-900/80 to-slate-800/80 backdrop-blur-sm border border-white/20">
          <CardHeader>
            ...
            <CardDescription className="text-white/70">
              View and manage EA Sports NHL match data for connected teams
            </CardDescription>
          </CardHeader>
          <CardContent>
            {teams.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-white/30 text-sm">
                  Add EA Club IDs to teams in the Team Management page to view their match data here.
                </p>
              </div>
            ) : (
                ...
                {teams.map((team) => (
                  ...
                  >
                    ...
                    <CardContent>
                      ...
                      >
                        <Activity className="h-4 w-4 mr-2 group-hover/btn:scale-110 transition-transform duration-200" />
                        View Matches
                      </Button>
                    </CardContent>
                  </Card>
